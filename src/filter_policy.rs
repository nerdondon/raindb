...
impl FilterPolicy for BloomFilterPolicy {
    ...
    */
    fn key_may_match(
        ...
        // rotated 17 bits.
        let delta: u32 = (hash >> 17) | (hash << 15);
        for idx in 0..*num_hash_functions {
...
const FILTER_BLOCK_KEY_PREFIX: String = "filter".to_string();

/// Get the serialized name for a filter block in a table file.
pub(crate) fn get_filter_block_name(filter_policy: Arc<Box<dyn FilterPolicy>>) -> String {
    FILTER_BLOCK_KEY_PREFIX + "." + &filter_policy.get_name()
}
